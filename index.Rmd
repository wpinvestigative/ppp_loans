---
title: "Public companies reporting Paycheck Protection Program Loans"
date: "4/30/2020"
output:
  html_document:
    code_folding: hide
...
library(tidyverse)
library(DT)
loans <- read_csv("data/ppp_loans_04-30.csv")
rownames(loans) <- c()
datatable(loans, extensions = 'Buttons', filter='top',
    options = list(
      pageLength = nrow(loans), 
      autoWidth = TRUE,
      dom = 'Bfrtip',
